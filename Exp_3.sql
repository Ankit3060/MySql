...
(6,'Basim',269,'AIML',106000,'20-Feb-2002','1-sept-2022','Gorakhpur',8641241);
SELECT * FROM Emp;
desc Emp;
SELECT Emp_id,salary,DOB FROM Emp;
UPDATE Emp SET salary=salary*2 WHERE Emp_Name='ankit';
select * from Emp;
delete from Emp where Emp_Name='Abhi';
SELECT * FROM Emp;